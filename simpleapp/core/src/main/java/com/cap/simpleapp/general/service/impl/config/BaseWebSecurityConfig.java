...
import com.cap.simpleapp.general.common.impl.security.CsrfRequestMatcher;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("waiter").password("waiter").roles("Waiter").and().withUser("cook")
        ...
        .withUser("chief").password("chief").roles("Chief").and().withUser("pparrado").password("asdf").roles("Chief");
  }

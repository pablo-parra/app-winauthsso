package com.cap.simpleapp.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.cap.simpleapp.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.cap.simpleapp.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */

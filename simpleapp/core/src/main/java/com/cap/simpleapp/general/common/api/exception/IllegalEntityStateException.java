package com.cap.simpleapp.general.common.api.exception;

import com.cap.simpleapp.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link com.cap.simpleapp.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the simpleappEntity entity.
